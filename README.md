...
| 🛰️ [**Block-Telemetry**](https://github.com/NephVx2/Block-Telemetry) | Blocks telemetry via the hosts file — 228 domains, 15 categories (Microsoft, Edge, Copilot, Adobe, Google, Brave and more). Hard-coded whitelist, dry-run mode, integrity checker. |
