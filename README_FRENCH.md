...
| 🛰️ [**Windows-Block-Telemetry**](https://github.com/NephVx2/Windows-Block-Telemetry) | Bloque la télémétrie via le fichier hosts — 228 domaines, 15 catégories (Microsoft, Edge, Copilot, Adobe, Google, Brave, Firefox et plus). Liste blanche codée en dur, mode simulation, vérificateur d'intégrité. |
