...
| 🛰️ [**Block-Telemetry**](https://github.com/NephVx2/Block-Telemetry) | Bloque la télémétrie via le fichier hosts — 228 domaines, 15 catégories (Microsoft, Edge, Copilot, Adobe, Google, Brave et plus). Liste blanche codée en dur, mode simulation, vérificateur d'intégrité. |
